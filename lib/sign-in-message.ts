export function buildSignInMessage(address: string, purpose = "mentor booking"): string {
...
const SIGNED_IN_KEY = "gnosis-mentor-signed-in";
...
export function setSignedInSession(
  address: string,
  verified: boolean,
): void {
